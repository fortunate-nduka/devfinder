...
const ContentBox = () => {
  return (
    <div className="bg-card px-5 py-7 rounded-lg">
      ...
      <div className="bg-body px-4 py-3 rounded-lg flex justify-between items-center text-center mb-8">
        <div className="">
          <h3>Repos</h3>
      ...
      <div className="space-y-5 capitalize">
        ...
        <div className="flex item-center">
          ...
          <span className="text-blue-500">https://github.blog</span>
        </div>
        <div className="flex item-center">
          <FaTwitter className="text-base mr-3" />
          <span className="text-blue-500">@iamfortunate</span>
        </div>
        <div className="flex item-center">
